...
function init(){
    ...
    var st = new $jit.ST({
        ...
        onCreateLabel: function(label, node){
			...
			// node.data.$autoWidth = false;
            // node.data.$width = 230 + 'px';      
        ...
        onBeforePlotNode: function(node){
            ...
            if (node.data.type == "inFavor") {
                if(node.selected)
				{					
					node.data.$color = "#FF7A04";					  
				} 
